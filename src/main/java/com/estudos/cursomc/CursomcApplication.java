...
import com.estudos.cursomc.domain.PagamentoComBoleto;
import com.estudos.cursomc.domain.PagamentoComCartao;
...
import com.estudos.cursomc.repositories.EnderecoRepository;
import com.estudos.cursomc.repositories.EstadoRepository;
import com.estudos.cursomc.repositories.ItemPedidoRepository;
import com.estudos.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("32335486", "358897412"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "75658555", cli1, c1);
